...
instance Print Program where
  prt i e = case e of
    Program funcs -> prPrec i 0 (concatD [prt 0 funcs])

instance Print Func where
  prt i e = case e of
    FuncDef type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print Stmt where
  prt i e = case e of
    ...
    FuncDecl type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    ...
    ForTo id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "to"), prt 0 expr2, doc (showString "do"), prt 0 stmt])
    ForDownto id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "downto"), prt 0 expr2, doc (showString "do"), prt 0 stmt])
