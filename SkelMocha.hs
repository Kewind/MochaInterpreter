...
transProgram x = case x of
  Program funcs -> failure x
transFunc :: Func -> Result
transFunc x = case x of
  FuncDef type_ ident args block -> failure x
transArg :: Arg -> Result
...
transStmt x = case x of
  ...
  FuncDecl type_ ident args block -> failure x
  ...
  ForTo ident expr1 expr2 stmt -> failure x
  ForDownto ident expr1 expr2 stmt -> failure x
  SExp expr -> failure x
